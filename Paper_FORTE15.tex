...
\begin{figure}[htbp]
\centering
\subfloat[\label{fig:small-example-net}]{\includegraphics[scale=\scalaRete]{images/tkk_tk_t_tutto_networkOnly}} \qquad
\subfloat[\label{fig:small-example01}]{\includegraphics[scale=\scalaRete]{images/tkk_tk_t_tutto01}} \qquad
\subfloat[\label{fig:small-example02}]{\includegraphics[scale=\scalaRete]{images/tkk_tk_t_tutto02}} \qquad
...
\begin{figure*}[!htb]
  \begin{center}
  \subfloat[\label{fig:network-abcd}]{\begin{minipage}[c][\reactantTAheight]{0.18\textwidth}\begin{center}\includegraphics[scale=1.0]{images/network_abcd}\end{center}\end{minipage}} \qquad\qquad
...
\begin{figure}[!htb]
\begin{center}
  \subfloat[Reaction-centered]{\includegraphics[scale=0.07]{images/grafico_ngf_reaction_10levels}\label{fig:comparison-graph-animo-reaction}}\qquad\quad
